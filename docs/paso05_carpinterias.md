...
<!-- TODO: Verificar con los carpinteros locales de Bata y Ebebiyín los formatos comerciales disponibles de tablón para puertas: grosor, ancho y longitudes estándar. Confirmar también qué tipo de bisagra es más habitual y accesible en el mercado local. -->
<!-- TODO: Documentar la disponibilidad de mosquitera en el mercado local: tipo de malla, precio por metro cuadrado y nombres comerciales. -->
...
<img src="imagenes/particiones.1.png" width="500" alt="Esquema estructural: montantes vs partición" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva axonométrica del interior de la vivienda, mostrando el cerramiento exterior con sus montantes estructurales y una partición interior independiente. El cuadro muestra un rincón del interior con dos montantes del cerramiento y el arranque de una partición perpendicular a ellos.
ESTADO: La estructura del cerramiento ya está completa. La partición interior está en construcción: solo se ve la solera en el suelo y el primer montante vertical. Las correas de cubierta apoyan sobre los montantes del cerramiento, no sobre la partición.
ROJO: Los montantes del cerramiento exterior, diferenciados claramente de la partición interior que arranca del suelo.
SIMPLIFICAR: No se muestra la cubierta completa. Solo los montantes del cerramiento, las correas que apoyan sobre ellos y el arranque de la partición.
-->
...
<!-- PROMPT:
ENCUADRE: Vista en planta del interior de la vivienda desde arriba. El cuadro muestra el suelo con las líneas de replanteo de dos particiones trazadas con cordel o tiza, y las marcas de los huecos de paso.
ESTADO: El replanteo está terminado. Se ven las líneas de los tabiques y las dos marcas que delimitan el hueco de paso de cada uno. Los montantes del cerramiento exterior son visibles en los bordes del espacio.
ROJO: Las líneas de replanteo de las particiones y las marcas de los huecos de paso.
SIMPLIFICAR: No hay piezas de madera aún. Solo las líneas sobre el suelo.
-->
...
<img src="imagenes/particiones.3.1.png" width="500" alt="Solera de arranque con hueco de paso" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva a nivel del suelo de una solera de arranque recién colocada. El cuadro muestra la pieza horizontal sobre el suelo con una interrupción que marca el hueco de paso.
ESTADO: La solera ya está clavada al suelo. La interrupción del hueco de paso es visible: la madera termina limpiamente en los dos límites del hueco.
ROJO: La interrupción de la solera en el hueco de paso, los dos extremos cortados a plomo.
SIMPLIFICAR: Solo la solera y el suelo. No hay montantes aún.
-->
...
<img src="imagenes/particiones.3.2.png" width="500" alt="Estructura completa de la partición" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva de la estructura completa de una partición interior: solera, montantes y pieza de coronación. El cuadro muestra un tramo de tabique de unos 2 metros de largo con un hueco de paso con sus dos montantes de jamba.
ESTADO: La estructura está terminada. La solera está en el suelo, los montantes verticales suben desde ella y la pieza de coronación los remata por arriba. Los dos montantes de jamba del hueco de paso son visibles y más juntos que el resto.
ROJO: Los dos montantes de jamba del hueco de paso.
SIMPLIFICAR: Sin tablas de cerramiento aún. Solo la estructura de madera.
-->
...
<img src="imagenes/particiones.4.png" width="500" alt="Cerramiento de la partición con tablas" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva de un tramo de partición interior con las tablas de cerramiento ya colocadas en una de las caras. El cuadro muestra unos 2 metros de tabique terminado por un lado, con el hueco de paso visible a un extremo.
ESTADO: Las tablas ya están clavadas en una cara. Se ven las juntas entre tablas, regulares y sin solape. La otra cara del tabique aún está sin tablar, mostrando los montantes interiores.
ROJO: Las juntas entre tablas y su regularidad a lo largo del tabique.
SIMPLIFICAR: Solo el tramo de tabique. No hay entorno ni personas.
-->
...
<img src="imagenes/particiones.5.png" width="500" alt="Hueco de paso terminado en la partición" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista frontal de un hueco de paso en una partición interior ya tablada. El cuadro muestra el hueco completo con sus dos jambas y el dintel horizontal en la parte superior. Las tablas de cerramiento llegan hasta los montantes de jamba y terminan limpiamente.
ESTADO: El hueco está formado. Las tablas de ambos lados llegan hasta los montantes de jamba. El dintel está colocado. No hay premarco ni puerta aún.
ROJO: El dintel horizontal en la parte superior del hueco.
SIMPLIFICAR: Solo el hueco y el tramo de tabique a cada lado. No hay entorno.
-->
...
<img src="imagenes/carpinteria.1.1.png" width="500" alt="Ensamble del premarco en el suelo" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva de un premarco de puerta tumbado en el suelo, recién ensamblado. El cuadro muestra el rectángulo completo con las cuatro piezas unidas en las esquinas.
ESTADO: El premarco ya está ensamblado. Una cinta métrica mide una de las diagonales para comprobar la escuadra. La otra diagonal está también marcada visualmente.
ROJO: Las dos diagonales del premarco y el punto central donde se cruzan.
SIMPLIFICAR: Solo el premarco en el suelo. No hay hueco de obra ni personas.
-->
...
<img src="imagenes/carpinteria.1.2.png" width="500" alt="Premarco instalado en el hueco de obra" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Sección transversal del encuentro entre el montante de jamba, la cuña y el premarco. El cuadro muestra unos 20 cm de ancho: el montante de jamba de madera, la cuña intercalada y la pieza del premarco. Un clavo atraviesa los tres elementos.
ESTADO: El premarco ya está instalado y clavado. La cuña está intercalada entre el montante y el premarco. El clavo ya está clavado pasando por el premarco, la cuña y el montante de jamba.
ROJO: La cuña y el clavo que fija el conjunto.
SIMPLIFICAR: Solo la sección del encuentro. No hay entorno ni hoja de puerta.
-->
...
<img src="imagenes/carpinteria.2.1.png" width="500" alt="Disposición de travesaños en Z en la hoja de puerta" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista frontal de una hoja de puerta completa tumbada en el suelo. El cuadro muestra la hoja entera con sus tablones verticales y los tres travesaños horizontales más el diagonal de rigidización formando una Z.
ESTADO: La hoja ya está ensamblada y clavada. Se ven claramente los tablones verticales, los tres travesaños horizontales y la diagonal en Z que une el travesaño superior con el inferior.
ROJO: El diagonal de rigidización en Z.
SIMPLIFICAR: Solo la hoja sobre el suelo. Sin entorno ni personas.
-->
...
<img src="imagenes/carpinteria.2.2.png" width="500" alt="Detalle del mortajado y fijación de bisagra" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva de detalle del encuentro entre la jamba del premarco y el canto de la hoja de puerta en la zona de la bisagra. El cuadro muestra unos 30 cm de altura centrados en una bisagra.
ESTADO: La bisagra ya está colocada. Se ve el mortajado en ambas piezas —jamba y canto de hoja— y la bisagra enrasada con la superficie. Los tornillos ya están colocados.
ROJO: La bisagra completa y el mortajado que la recibe en ambas piezas.
SIMPLIFICAR: Solo el detalle de la bisagra. No se muestra la hoja completa ni el entorno.
-->
...
<!-- TODO: Definir en el prototipo de la UNGE cuál de estas soluciones se adopta como estándar y documentar el detalle constructivo correspondiente. -->
...
<img src="imagenes/carpinteria.3.1.png" width="500" alt="Hoja abatible de ventana" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva exterior de una ventana con hoja abatible abierta hacia el interior. El cuadro muestra el hueco completo con el premarco, la hoja en posición abierta sujetada por un gancho y el cerramiento de tablas alrededor.
ESTADO: La ventana está abierta. La hoja gira sobre las bisagras de la jamba lateral y está sujeta en posición abierta con un gancho fijado al montante interior.
ROJO: Las bisagras y el gancho de sujeción en posición abierta.
SIMPLIFICAR: Solo la ventana y el tramo de cerramiento inmediato. No hay entorno exterior ni interior.
-->
...
<img src="imagenes/carpinteria.3.2.png" width="500" alt="Lamas fijas de madera en ventana" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Sección transversal de un hueco de ventana con lamas fijas. El cuadro muestra el premarco en sección y cuatro o cinco lamas inclinadas entre 30° y 45° fijadas a las jambas. Una flecha indica la dirección del aire que entra y otra indica la dirección de la lluvia que rebota.
ESTADO: Las lamas ya están colocadas. La inclinación y la separación entre lamas son regulares.
ROJO: Las lamas de madera y su ángulo de inclinación.
SIMPLIFICAR: Solo la sección del hueco. No hay entorno.
-->
...
<img src="imagenes/carpinteria.4.1.png" width="500" alt="Sección del alféizar con goterón" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Sección transversal del alféizar de una ventana. El cuadro muestra unos 25 cm de ancho: el umbral del premarco, la pieza de alféizar inclinada hacia el exterior y el goterón en la cara inferior.
ESTADO: El alféizar ya está colocado. Se ve claramente la inclinación hacia el exterior y el goterón: una pequeña ranura o vuelo en la cara inferior que interrumpe el recorrido del agua. Una flecha indica la dirección del agua que cae y cómo el goterón la desvía hacia afuera.
ROJO: El goterón y la flecha que indica la dirección del agua desviada.
SIMPLIFICAR: Solo la sección del alféizar. No hay entorno.
-->
...
<img src="imagenes/carpinteria.4.2.png" width="500" alt="Protección del dintel con chapa" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Sección transversal del encuentro entre el cerramiento exterior y el cabecero del premarco en la zona del dintel. El cuadro muestra unos 20 cm de alto: las tablas de cerramiento, el cabecero del premarco y la pieza de chapa o madera que lo protege.
ESTADO: La pieza de protección ya está colocada. Se ve cómo la chapa o madera inclinada desvía el agua de lluvia hacia la fachada exterior, sin dejarla entrar en la junta entre el premarco y el cerramiento.
ROJO: La pieza de protección del dintel y la dirección del agua que desvía.
SIMPLIFICAR: Solo la sección del encuentro. No hay entorno ni hoja de carpintería.
-->
...
<!-- TODO: Documentar en la próxima misión de campo los talleres de carpintería existentes en los municipios de actuación, su capacidad de producción y los precios orientativos de puertas y ventanas sencillas. -->
...
## ⏭️ Siguiente paso: Mantenimiento
