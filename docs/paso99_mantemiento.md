...
<!-- TODO: Contrastar con el equipo de campo los meses exactos de inicio de estación seca y lluviosa en las zonas de actuación del proyecto (litoral de Bata, zona interior fang), ya que pueden variar entre el litoral y el interior. Incorporar fechas orientativas concretas en la versión definitiva. -->
...
<!-- TODO: Incorporar fotografías de referencia de cada patología cuando estén disponibles: grieta de retracción vs. grieta estructural, eflorescencia activa vs. antigua, galería de termitas en zócalo. -->
...
**Grietas estructurales** — Grietas de más de 1 mm de apertura, con dirección definida —generalmente diagonal o vertical— que atraviesan el bloque de lado a lado. Pueden indicar movimiento del terreno, asiento diferencial de la cimentación o sobrecarga puntual. Requieren valoración técnica antes de actuar.
...
<!-- PROMPT:
ENCUADRE: Vista frontal de un tramo del zócalo de bloques de hormigón de unos 80 cm de ancho. El cuadro muestra desde el nivel del suelo hasta la junta con el durmiente de madera.
ESTADO: La inspección está en curso. Una mano con linterna ilumina la junta entre el zócalo y el durmiente. En la cara del zócalo son visibles dos anomalías: una mancha blanca de eflorescencia en la parte baja y una galería de tierra de termitas subiendo en diagonal hacia la junta superior.
ROJO: La galería de tierra de termitas, desde donde nace en el suelo hasta donde llega a la junta con el durmiente.
SIMPLIFICAR: No se muestra el interior ni el entorno completo de la vivienda. Solo el tramo de zócalo con las dos anomalías y la mano con linterna.
-->
...
<!-- TODO: Incorporar fotografías de referencia de cada patología cuando estén disponibles: tabla con pudrición en extremo, junta abierta en solape, montante con deformación visible. -->
...
<img src="imagenes/mantenimiento.3.png" width="500" alt="Inspección del cerramiento" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista frontal de un tramo de cerramiento de tablas de unos 60 cm de ancho y tres hiladas de altura. El cuadro muestra la parte baja del cerramiento, cerca del durmiente.
ESTADO: La inspección está en curso. Una mano presiona con un punzón la cara de la tabla más baja. La tabla cede visiblemente bajo la presión, indicando pudrición. En la junta entre la primera y la segunda hilada se aprecia una separación visible.
ROJO: El punzón y la zona de la tabla que cede bajo la presión, mostrando la pudrición localizada.
SIMPLIFICAR: No se muestra el zócalo ni el entorno. Solo el tramo de tablas con la mano y el punzón.
-->
...
<!-- TODO: Incorporar fotografías de referencia de cada patología cuando estén disponibles: tornillo sin arandela, solape abierto, inicio de oxidación en borde de chapa cortado. -->
...
<img src="imagenes/mantenimiento.4.png" width="500" alt="Inspección de la cubierta" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva desde arriba y ligeramente de lado de un tramo de cubierta de chapa corrugada de unos 80 cm de ancho. El cuadro muestra tres chapas con sus solapes laterales y longitudinales.
ESTADO: La inspección está en curso. Se distinguen dos anomalías: un tornillo sin arandela en la cresta de una corruga, con el agujero visible alrededor de la cabeza del tornillo, y una zona de oxidación marrón en el borde cortado de una de las chapas.
ROJO: El tornillo sin arandela y el agujero desprotegido alrededor de su cabeza.
SIMPLIFICAR: No se muestra la estructura de la cercha ni el interior. Solo las chapas con las dos anomalías.
-->
...
<!-- TODO: Incorporar fotografías de referencia de cada patología cuando estén disponibles: bisagra oxidada con tornillos sueltos, batiente desajustado con luz visible en la junta, premarco con inicio de pudrición en la base. -->
...
<img src="imagenes/mantenimiento.5.png" width="500" alt="Inspección de la carpintería" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista frontal de una puerta entreabierta, mostrando el hueco completo y el marco. El cuadro muestra la bisagra superior y la inferior, y la junta entre la hoja y el premarco.
ESTADO: La inspección está en curso. La bisagra inferior presenta oxidación visible y uno de sus tornillos está suelto, con la cabeza ligeramente levantada respecto al marco. En la base del premarco hay una zona oscurecida que indica inicio de pudrición.
ROJO: La bisagra inferior con el tornillo suelto.
SIMPLIFICAR: No se muestra el interior de la vivienda ni el cerramiento completo. Solo la puerta, el marco y las dos bisagras.
-->
...
<img src="imagenes/mantenimiento.6.png" width="500" alt="Señales de ataque activo de termitas" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista frontal del pie de un montante de madera apoyado sobre el durmiente, con el zócalo de hormigón visible en la parte baja. El cuadro muestra unos 50 cm de altura desde el suelo hasta la mitad del montante.
ESTADO: El ataque es activo. Se distinguen tres señales simultáneas: una galería de tierra oscura y húmeda subiendo por la cara exterior del zócalo hasta el durmiente, serrín claro acumulado en la junta entre el durmiente y el montante, y una mano golpeando el montante con el martillo para comprobar el sonido.
ROJO: La galería de tierra desde el zócalo hasta el durmiente.
SIMPLIFICAR: Solo el pie del montante, el durmiente y el tramo superior del zócalo. No hay entorno ni personas completas.
-->
...
<img src="imagenes/mantenimiento.7.1.png" width="500" alt="Extracción de la tabla dañada" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista frontal de un tramo de cerramiento de unos 60 cm de ancho. El cuadro muestra la tabla que se va a extraer y las dos tablas adyacentes —la superior y la inferior.
ESTADO: La extracción está en curso. Un formón está introducido entre la tabla dañada y la tabla superior, haciendo palanca para aflojar el clavo del montante central. La tabla dañada está ligeramente separada de la posición original en el punto del formón.
ROJO: El formón y el punto de palanca donde actúa sobre la junta.
SIMPLIFICAR: Solo el tramo de tres tablas con el formón. No hay entorno ni personas completas.
-->
...
<img src="imagenes/mantenimiento.7.2.png" width="500" alt="Colocación de la tabla nueva" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista frontal del mismo tramo de cerramiento, ahora con la tabla nueva ya colocada. El cuadro muestra la tabla nueva entre las dos tablas adyacentes.
ESTADO: La tabla nueva está en posición y se está clavando. Una mano sostiene la tabla en la posición correcta mientras la otra clava en el montante central. El solape con la tabla superior e inferior es uniforme y correcto.
ROJO: La tabla nueva, distinguiéndola por su color de madera más claro respecto a las tablas envejecidas adyacentes.
SIMPLIFICAR: Solo el tramo de tres tablas con las manos. No hay entorno ni personas completas.
-->
...
<img src="imagenes/mantenimiento.8.1.png" width="500" alt="Extracción de la chapa dañada" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Vista en perspectiva desde arriba de un tramo de cubierta. El cuadro muestra tres chapas: la dañada en el centro y las dos adyacentes a los lados.
ESTADO: La extracción está en curso. Los tornillos de la chapa central ya han sido retirados. Dos manos están deslizando la chapa dañada hacia arriba, separándola de la chapa inferior sobre la que solapa.
ROJO: La chapa que se está extrayendo, distinguiéndola por la oxidación visible en su superficie.
SIMPLIFICAR: Solo las tres chapas y las manos. No hay cerchas ni rastreles visibles.
-->
...
<img src="imagenes/mantenimiento.8.2.png" width="500" alt="Fijación de la chapa nueva" style="display: block; margin: auto;">
<!-- PROMPT:
ENCUADRE: Sección transversal de la chapa corrugada sobre el rastrel, mostrando el tornillo nuevo con la arandela de neopreno colocada en la cresta.
ESTADO: El tornillo ya está fijado. La arandela de neopreno está ligeramente comprimida entre la cabeza del tornillo y la cresta de la chapa, sellando el agujero. Se ve claramente la diferencia de posición respecto a un tornillo mal colocado en el valle, que aparece en segundo plano en gris.
ROJO: El tornillo con la arandela nueva colocado correctamente en la cresta de la corruga.
SIMPLIFICAR: Solo la sección de la chapa, el rastrel y los dos tornillos —el correcto en rojo y el incorrecto en gris. No hay entorno.
-->
...
<!-- TODO: Contrastar con el equipo de campo los productos de tratamiento de termitas y de madera disponibles comercialmente en Guinea Ecuatorial e incorporar nombres locales, precios orientativos y modo de aplicación a la guía definitiva. -->
