...
<img src="imagenes/cimentacion.3a.png" width="500" alt="Hormigón de limpieza" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar la sección transversal de la zanja con la capa de hormigón de limpieza ya vertida en el fondo. Se distingue claramente el suelo natural, la capa de hormigón pobre de 5–10 cm de espesor y el espacio libre que queda encima para la armadura. El espesor de la capa está remarcado en rojo. Dibujo técnico a mano alzada, escala de grises. -->
...
<img src="imagenes/cimentacion.3b.png" width="500" alt="Lámina de plástico" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar la sección transversal de la zanja con la lámina de plástico extendida en el fondo y subiendo por las paredes laterales. Se ven los solapes entre piezas de plástico y cómo la lámina sube por los laterales de la zanja. Los solapes y la parte que sube por las paredes están remarcados en rojo. Dibujo técnico a mano alzada, escala de grises. -->
...
<img src="imagenes/cimentacion.4a.png" width="500" alt="Doblado de varilla en L" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar la operación de doblar una varilla de acero corrugado en forma de "L" usando un tubo metálico hueco como palanca. Se ven las manos sujetando el tubo, la varilla atravesándolo y el ángulo de 90° resultante en el extremo. El tubo y el ángulo formado están remarcados en rojo. Vista en perspectiva, dibujo técnico a mano alzada, escala de grises. -->
...
<img src="imagenes/cimentacion.4b.png" width="500" alt="Armadura horizontal sobre calzos" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar la vista en sección y en perspectiva de las dos barras horizontales de armadura colocadas sobre los calzos en el fondo de la zanja. Se distinguen los calzos de bloque que elevan las barras del fondo, la separación entre las dos barras paralelas y el alambre de atado. Los calzos y la separación entre barras están remarcados en rojo. Dibujo técnico a mano alzada, escala de grises. -->
...
La posición de cada espera debe planificarse durante el replanteo, porque deben quedar centradas dentro del hueco interior de los bloques del futuro zócalo. Los cordeles del replanteo sirven de referencia. Una espera mal posicionada impide colocar los bloques encima sin forzarlos. <!-- TODO: importante remarcar como tiene que ser este replanteo, ya que no se cuenta con los bloques para saber como tiene que ir esta armadura, asi que habra que hacerlo a partir del cordel... lo cual puede ser mucho mas complicado para una persona que no es especialista en construccion -->

### Proceso

1. La base de cada espera vertical se ata a la armadura horizontal con alambre, en la posición correcta. <!-- TODO: realmente estas esperas verticales pueden ir clavadas directamente en el terreno, no es la mejor practica probablemente pero eso permite colocarlas de una forma sencilla, puesto que no hay aire bajo tierra la corrosion no deberia de ser un problema -->
...
<img src="imagenes/cimentacion.5.png" width="500" alt="Esperas verticales" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar la sección transversal de la zanja con la armadura horizontal ya colocada y las esperas verticales saliendo hacia arriba. Se ve la guía en "V" de bambú o listón sujetando una de las esperas en posición vertical. En la parte superior, un bloque de hormigón se presenta sobre la zanja —sin apoyar en el hormigón fresco— para mostrar cómo la espera debe pasar por el hueco interior con holgura. La espera y la guía en "V" están remarcadas en rojo. Dibujo técnico a mano alzada, escala de grises. -->
...
### ¿Para qué sirve?
<!-- NEW: una cuestion que me gustaria explorar es como se puede mejorar el cemento/hormigon que tienen ellos alli ya que tiene bastante poca calidad para ser sinceros esta hecho con arena de la playa o de muy mala calidad y el hormigon acaba deshaciendose con cogerlo, hay que pensar formas como puede ser mezclarlo con tierra o con piedras por un lado para abaratarlo, pero tambien para mejorar los materiales disponibles del entorno -->
...
<img src="imagenes/cimentacion.6.png" width="500" alt="Mezcla manual del hormigón" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar la operación de mezcla manual del hormigón sobre una superficie plana. Se ven los áridos y el cemento extendidos en seco, el hueco central donde se añade el agua y la pala realizando la mezcla circular desde los bordes hacia el centro. El hueco central y la dirección de mezcla están remarcados en rojo. Dibujo técnico a mano alzada, escala de grises. -->
...
### Vertido <!-- TODO: este paso hay que desarrollarlo mucho mejor ya que puede ser complejo, especialmente lo de las juntas de hormigonado, como se tiene que planificar y como tiene que ser este paso a paso mas detallado -->
...
<img src="imagenes/cimentacion.7.png" width="500" alt="Vertido y compactación del hormigón" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar el vertido del hormigón en la zanja y la operación de compactación manual con un palo. Se ve una persona introduciendo el palo verticalmente en el hormigón fresco para eliminar burbujas de aire, y al fondo otro operario mezclando o acarreando. El palo de compactación y las burbujas que salen del hormigón están remarcados en rojo. Vista en perspectiva, dibujo técnico a mano alzada, escala de grises. -->
...
<img src="imagenes/cimentacion.zocalo.png" width="500" alt="Altura del zócalo" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar el alzado lateral de la vivienda mostrando la relación entre el nivel del suelo, el zócalo de bloques de hormigón y el arranque de la estructura de madera. Se ve claramente la cota de altura del zócalo —3 hiladas de bloque, equivalente a unos 60 cm— entre el nivel del suelo terminado y la cara superior del zócalo donde comenzará la estructura de madera. La cota de 60 cm y la línea de separación entre zócalo y estructura de madera están remarcadas en rojo. Dibujo técnico a mano alzada, escala de grises. -->
...
<!-- TODO: hay un factor que considero que cabe considerarse y es que los bloques de hormigon pueden ser de muy mala calida ya que los hacen in situ con moldes que ademas tienen un formato pequeño, de unos 15 cm de ancho no de 20 como el estandar, asi que las caracteristicas de los bloques en si ya deja un poco que desear, por lo tanto como se puede mejorar las condiciones de trabajo de los mismos -->
### ¿Para qué sirve?
...
<img src="imagenes/cimentacion.8.png" width="500" alt="Preparación del bloque para la espera" style="display: block; margin: auto;">
...
<img src="imagenes/cimentacion.9a.png" width="500" alt="Trabado de hiladas" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar la vista en alzado de dos hiladas de bloques de hormigón trabadas. Se ve claramente cómo las juntas verticales de la hilada superior no coinciden con las de la hilada inferior, y cómo el bloque superior queda centrado sobre la junta de los dos bloques de abajo. Las juntas verticales y el desplazamiento de trabado están remarcados en rojo. Dibujo técnico a mano alzada, escala de grises. -->
...
<img src="imagenes/cimentacion.9b.png" width="500" alt="Trabado en esquina" style="display: block; margin: auto;">
<!-- PROMPT: Esta imagen tiene que representar la vista en perspectiva de una esquina del zócalo de bloques con dos hiladas ya colocadas. Se ve cómo en la primera hilada el bloque de esquina se orienta en una dirección y en la segunda hilada se orienta en la dirección perpendicular, creando el trabado. El bloque de esquina de la segunda hilada y la alternancia de orientación están remarcados en rojo. Dibujo técnico a mano alzada, escala de grises. -->
